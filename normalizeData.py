...
class Normalizer:
	def __init__(self, delimiter, filename):
		inFile=open(fileName,"r")

		self.numNonDataItems = 0
		self.numFeatures = 0
		self.numClasifications = 0
		self.documentation = ""
		self.data = []
	...
	def normailze(self, data, numNonDataItems, numFeatures):
	...
	def saveData(self, numNonDataItems, numFeatures, numClasifications, documentation, data):
